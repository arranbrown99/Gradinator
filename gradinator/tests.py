...
class ModelTests(TestCase):
    ...
    def test_course_add(self):
        ...
        c = {"WAD": {"name": "Web App Development",
                     ...
                     "description": "The aim        form = of this course is to provide students with a comprehensive overview of web application development. It will provide students with the skills to design and develop distributed web applications in a disciplined manner, using a range of tools and technologies. It will also strengthen their understanding of the context and rationale of distributed systems. ",
